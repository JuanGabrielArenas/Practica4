...
namespace libParametros
{
    ...
    #region "Atributos/Propiedades"
        ...
        {
              get;  private set;   // set { atrib = value; }   get { return atrib; }
        }
        //Propiedad de solo salida
        public string Error     
        { 
    ...
    #region "Métodos Públicos"
        public bool generarCadenaCnx( string strNombreSitio )   // WebLeerXML
        {
            try
            {
                ...
                strSegInt = objNodo.InnerText.ToLower().Trim();  //ToUpper()
